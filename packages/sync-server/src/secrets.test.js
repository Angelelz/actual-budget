...
describe('secretsService', () => {
  // A non-SimpleFIN secret name: SimpleFIN secrets are scoped per budget file
  // and have their own dedicated tests, so the generic secrets-API tests use a
  // normal admin-managed secret here.
  const testSecretName = SecretName.gocardless_secretId;
